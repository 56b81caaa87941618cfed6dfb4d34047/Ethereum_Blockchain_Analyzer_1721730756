...
Vue.component("purple_feature_grid_component_1721730758", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm">Stay ahead of the game with our cutting-edge Ethereum blockchain analysis. Our platform monitors new blocks as they are mined, giving you instant insights into emerging trends and activity.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm">Gain a deeper understanding of on-chain activity with our powerful transaction analysis tools. Dissect and visualize intricate transaction patterns, smart contract interactions, and more.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm">Ensure the security and reliability of your smart contracts with our comprehensive auditing services. Our experts thoroughly analyze the code, identifying potential vulnerabilities and providing actionable recommendations.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm">Tailor your blockchain monitoring experience with our highly customizable dashboards. Visualize the metrics and data that matter most to you, creating a personalized command center for your Ethereum analysis needs.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container"><h4 id="feature-5-title" class="flex-1 text-slate-50 font-medium">Wallet Monitoring</h4></div>
            </div>
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm">Keep a watchful eye on your Ethereum wallets and addresses of interest. Set up alerts for suspicious activity, track balances, and monitor incoming and outgoing transactions with ease.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container"><h4 id="feature-6-title" class="flex-1 text-slate-50 font-medium">Powerful API Integration</h4></div>
            </div>
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm">Seamlessly integrate our Ethereum blockchain analysis capabilities into your existing systems and applications. Our robust APIs provide secure and efficient access to our wealth of data and analytical tools.</p></div>
        </div>
    </div>`,
        data() {
            return {
